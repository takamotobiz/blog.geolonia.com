...
- [x] 名前：Sample
- [x] URL：https://labo.takamoto.biz/z7/data/v3/{z}/{x}/{y}.pbf
...
- [x] Style URL：https://labo.takamoto.biz/z7/styles/klokantech-basic/style.json
...
- [x] 名前：地理院地図（航空写真）
- [x] URL：https://cyberjapandata.gsi.go.jp/xyz/seamlessphoto/{z}/{x}/{y}.jpg
